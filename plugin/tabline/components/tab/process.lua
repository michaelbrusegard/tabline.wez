...
return {
  default_opts = {
    process_to_icon = {
      ...
      ['gh'] = { wezterm.nerdfonts.dev_github_badge, color = { fg = colors.indexed[16] or nil } },
      ['git'] = { wezterm.nerdfonts.dev_git, color = { fg = colors.indexed[16] or nil } },
      ...
      ['lazygit'] = { wezterm.nerdfonts.cod_github, color = { fg = colors.indexed[16] or nil } },
      ...
      ['yazi'] = { wezterm.nerdfonts.md_duck, color = { fg = colors.indexed[16] or nil } },
